...
---
> 本文介绍 DDIM（Denoising Diffusion Implicit Models, Song et al. 2021），一种将 DDPM 的随机采样推广为确定性隐式采样的加速方法。建议先阅读 [DDPM 基础]({% post_url 2.Machine Learning/3.扩散模型/2022-10-01-DDPM：去噪扩散概率模型 %})。
...
> 详见 [DPM-Solver]({% post_url 2.Machine Learning/4.扩散模型补充/2023-08-01-扩散模型补充：DPM-Solver高阶求解器 %})。
...
> 下一篇：[Score Matching：基于得分的生成模型]({% post_url 2.Machine Learning/3.扩散模型/2022-12-01-Score-Matching：基于得分的生成模型 %})
