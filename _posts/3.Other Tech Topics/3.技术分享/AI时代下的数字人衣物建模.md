...
1.离散几何表达（Mesh网格，点云，体素）

2.隐式表达（SDF，隐函数）

3.CAD表达：NURBS曲面参数方程，CSG，BRep等

4.参数化表达



人体有SMPL参数化表达，但是人体细节太多SMPL表达力不够。
...
《ClothCap》：通过MRF方法对扫描模型进行顶点分割抽取出其中衣物模型 《IPNet》(MPI_meshRegister,RVH_MeshRegister)通过扫描模型进行SMPL配准 