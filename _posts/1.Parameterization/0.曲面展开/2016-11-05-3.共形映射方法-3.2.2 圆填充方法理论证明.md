...
> 本文聚焦 Circle Pattern 方法中 **Bobenko-Springborn 变分原理**的推导，阐释求圆半径的问题如何通过 **Rivin 定理**与**理想双曲四面体的体积**建立深刻对偶，从而转化为凸优化问题。

---

## 1. 理论基础：KAT 定理与 Rivin 定理
...
- $\theta_e$ 是弹簧的"自然长度"
- 偏离自然长度时产生"恢复力"（曲率 $K_i$）
- 平衡位置 $\nabla E = 0$ 即所求 Circle Pattern

---

## 5. Coherent Angle System 与 Colin de Verdière

### 5.1 Coherent Angle System
...
### 5.2 Colin de Verdière 变分原理（1991）
