...
$$
\sigma_1(A_j) - \sigma_2(A_j) \geq 0 \tag{1.1}
$$

$$
\frac{\sigma_1(A_j)}{\sigma_2(A_j)} \leq C \tag{1.2}
$$
...
那么受限条件 (1.1)-(1.2) 就可以转化为如下形式：

$$
|\alpha| - |\beta| \geq 0 \quad \text{(无翻转)} \tag{1.1'}
$$

$$
\frac{|\alpha| + |\beta|}{|\alpha| - |\beta|} \leq C \quad \text{(共形扭曲有界)} \tag{1.2'}
$$
...
$$
|\beta| \leq \frac{C-1}{C+1} |\alpha| \tag{1.3}
$$
