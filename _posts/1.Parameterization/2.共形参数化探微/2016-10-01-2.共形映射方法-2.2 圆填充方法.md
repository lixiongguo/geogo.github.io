...
圆是共形几何的基本构建单元，**圆填充可以用来近似共形映射（Thurston）**，共形映射保持角度和圆不变：将**圆映射为圆**且保持两个圆之间的**相交角度**不变
...
![image-20260529130155610](D:\MyDocs\geogo.github.io\imgs\image-20260529130155610.png)
...
![image-20260529130258257](D:\MyDocs\geogo.github.io\imgs\image-20260529130258257.png)
...
![image-20260529130456809](D:\MyDocs\geogo.github.io\imgs\image-20260529130456809.png)

![image-20260529130445146](D:\MyDocs\geogo.github.io\imgs\image-20260529130445146.png)
...
> 延伸阅读：如果希望从几何本体理解“为什么会出现 Lobachevsky 函数与体积项”，可继续看附录 `6.3.1 双曲平面` 中新增的“**双曲理想四面体**”小节（`_posts/1.Parameterization/7.附录/2019-07-01-6.附录-6.3.1 双曲平面.md`）。该小节把 Circle Pattern 的角度能量直接对应到理想四面体体积公式。
