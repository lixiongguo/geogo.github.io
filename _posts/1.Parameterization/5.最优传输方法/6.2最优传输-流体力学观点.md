...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123170214247.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123160455088.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123160612191.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123160820558.png)

### 6.3 问题形式化

映射 $\tilde{u}$ 需保质量（质量守恒），满足 Jacobi 方程：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123161205926.png)

代价函数定义为：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123161456850.png)

最优传输映射是代价最小的**保面积映射**。由 **Brenier 定理**，该映射存在且唯一，且为某凸函数（势函数）的梯度，化为求解以下偏微分方程：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123161702884.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123165202217.png)

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123165439073.png)

### 7.2 求初始映射

在 $\mathbb{R}^2$ 上分别沿横轴和纵轴求解 1D 传输，构造初始保质量映射：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123165615709.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123165849676.png)

极分解后转化为求解 Dirichlet 问题：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123165902390.png)

### 7.4 完整算法流程

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123170112220.png)

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260123170127768.png)
