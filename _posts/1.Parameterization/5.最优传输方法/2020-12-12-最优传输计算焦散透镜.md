...
![焦散设计三步流程](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-pipeline.png)
...
![源分布、初始 Voronoi、目标分布与优化后 Power diagram](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-otm-voronoi-power.png)
...
![Natural neighbor interpolation of OTM onto source mesh vertices](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-natural-neighbor.png)
...
![计算目标法向与优化 3D 位置](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-target-optimization.png)

*图：左 computing the target normal；右 optimizing the 3D position。*

![曲面优化迭代示意](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-surface-optimize.png)

透镜用高密度三角网格离散。初始为规则平板网格，优化后网格在曲率变化剧烈处自动加密：

![透镜平板三角网格](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-slab-mesh.png)

![网格加密细节](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-mesh-detail.png)
...
| 仿真 | 实物 |
|:---:|:---:|
| ![棋盘格仿真](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-checker-render.png) | ![棋盘格实物](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/caustic-checker-fabricated.png) |
