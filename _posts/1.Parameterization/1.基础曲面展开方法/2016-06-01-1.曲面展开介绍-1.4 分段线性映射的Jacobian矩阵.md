...
![image-20230529213203001](/Users/lgxgeogo/Desktop/MyDoc/lixiongguo.github.io/imgs/jacobian sigma.png)
...
$$
\boxed{\text{等距} \;\subset\; \text{有界扭曲} \;\subset\; \text{保角}} \qquad
\boxed{\text{等距} \;\subset\; \text{保面积}}
$$

**等距映射**是唯一同时保角和保面积的映射类，也是参数化追求的终极目标——但在曲面展开中通常无法严格实现（Gauss 绝妙定理）。

## 2.4 基于奇异值优化的展开方法 — ARAP
