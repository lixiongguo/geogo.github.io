...
<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617112407749.png" alt="浸入与嵌入示意" style="zoom:50%;" />
...
<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617103846235.png" alt="embedding and immersion mesh" style="zoom:50%;" />

所有的嵌入都是浸入，但并非所有的浸入都是嵌入。嵌入是浸入的一个“完美”子集。

**球面外翻（Smale）**：标准球面与内外翻转后的球面，在 **immersion + regular homotopy** 下可以连通——中间阶段允许自交，局部始终不退化即可。若要求每时刻都是 **embedding**（isotopy，全局无自交），则外翻不可能，因为翻转必须经过自交。对照：平面圆在 immersion 下也不能外翻（转数不变量）；球面在 $\mathbb R^3$ 中反而可以，正是因为维数更高、允许自交带来额外自由度。
...
Regular homotopy 与 isotopy 的区别在于：前者只要求每时刻局部不退化，后者还要求每时刻全局无自交——参数化优化中从初始解到目标解的连续路径，通常只保证局部合法性。

<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617111014847.png" alt="平面曲线转数示意" style="zoom: 25%;" />

<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617111037951.png" alt="球面外翻示意" style="zoom: 33%;" />
...
![微分推前切向量](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617103321345.png)

<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617105826886.png" alt="切向量经微分映射到曲面" style="zoom:33%;" />
...
<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617104339877.png" alt="黎曼度量示意" style="zoom:50%;" />
...
![参数化与嵌入示意](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617103410545.png)
...
![Enneper 曲面](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617104900320.png)

共形因子 $\phi(u,v)=u^2+v^2+1$，度量即 $\phi^2 I$。

<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617110116447.png" alt="Enneper conformal factor" style="zoom:33%;" />
...
![Poincare 圆盘](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617110553623.png)
...
<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617151920757.png" alt="image-20260617151920757" style="zoom:50%;" />
...
<img src="https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20260617105624828.png" alt="transition map 相容结构" style="zoom:33%;" />
