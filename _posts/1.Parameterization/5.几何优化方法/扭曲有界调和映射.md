...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326194001555.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326193741329.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326194131187.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326194610150.png)

$$|f_z|^2 - |f_{\bar{z}}|^2 \geq \varepsilon > 0$$

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326194555045.png)

对于 5d) 的凸化：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326194702236.png)

用复导数表示为二阶锥约束（SOC）：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326194647654.png)

并进一步限制在二阶凸锥中：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326195026284.png)

$$\left\| \begin{pmatrix} 2\,\text{Re}(f_z) \\ 2\,\text{Im}(f_z) \end{pmatrix} \right\|_2 \leq |f_z|^2 + |f_{\bar{z}}|^2 - \varepsilon$$

#### 1.2.5.2 有界扭曲约束的凸化

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326194926784.png)

$$|f_{\bar{z}}| \leq \kappa \, |f_z|, \quad \kappa = \frac{K-1}{K+1}$$

复导数表示：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326194857851.png)

并限制在二阶凸锥中：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326195506007.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326195946561.png)

$$E_{\text{reg}}(f) = \int_\Omega \left\| \nabla f - R(\nabla f) \right\|_F^2 \, dA$$

其中 $R(\nabla f)$ 是 $\nabla f$ 的最近旋转矩阵。由于这个能量也是非凸的所以做如下凸化，过程参考 Lipman 的文章：

![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326200338839.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326200049856.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326200432211.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326200819142.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326200901879.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326201834471.png)
...
![](https://lgximgs.oss-cn-beijing.aliyuncs.com/images/image-20250326202125560.png)
