...
from ensemble_dynamic_model import EnsembleDynamicsModel
from ensemble_dynamic_model import FakeEnv
...
class CEM:
    def __init__(self, n_sequence, elite_ratio, fake_env:FakeEnv, upper_bound,
                 lower_bound):
...
class PETS:
    ''' PETS算法 '''
    def __init__(self, env, buffer_size, n_sequence, elite_ratio,
